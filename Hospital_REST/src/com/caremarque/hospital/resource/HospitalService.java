...
public class HospitalService {
	...
	public String createHospital(
		    ...
		    String result = iHospitalService.createHospital(hospital);
		    return result;
	...
	public String getHospitals() {
		return iHospitalService.getHospitals();
	}
	  ...
	  return iHospitalService.getHospital(hospitalId);
	...
	public String deleteHospital(String hospitalData) {
		...
		String result = iHospitalService.DeleteHospital(hospitalId);
	...
	public String createAppointment(@PathParam("hospitalId") String hospitalId) {
		hospitalServiceImpl.createAppointment(hospitalId);
